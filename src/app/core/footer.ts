        ...
        <div class="container">
            <div class="grid-container">
                <div class="links-container">
                    ...
                    <div (click)="redirectTo('certificates')" class="link">
                        <a>Сертификаты</a>
                        <a>Сертификаты</a>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 9" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="certificates-container">
                <p>© 2026 Shatun. Все права оформлены.</p>
                <a href="/sertificates/ОБЩИЕ_ПОЛОЖЕНИЯ_И_ПРАВИЛА_ТУРИСТИЧЕСКОГО_КЛУБА_«ШАТУН».docx">Общие положения</a>
            </div>
        </div>
    `,
    styles: `
        ...
        .certificates-container {
            ...
            padding:         0 16px;
            font-size:       18px;
            color:           rgba(from var(--background-neutral) r g b / 0.7);
